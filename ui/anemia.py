    ...
    if st.button("Dự đoán bệnh"):
        ...
        if len(invalid_inputs)>0:
            ...
            input_list = [("1 - LYM", lym), ("2 - NEUT", neut), ("3 - MON", mon), ("4 - EOS", eos), ("5 - BASO", baso),
                ("6 - HGB", hgb), ("7 - HCT", hct), ("8 - MCV", mcv), ("9 - MCH", mch), ("10 - MCHC", mchc),
                ("11 - RDW", rdw), ("12 - PLT", plt), ("13 - MPV", mpv), ("14 - RBC", rbc), ("15 - WBC", wbc)]
            query.insert_anemia(user_id,lym, neut, mon, eos, baso, hgb, hct, mcv, mch, mchc,
                                rdw, plt, mpv, rbc, wbc, prediction[0])
            if prediction[0] == 1:
